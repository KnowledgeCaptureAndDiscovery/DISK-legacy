...
public class GmailService {
	...
	private static String USER_NAME = "disk.ai.agent@gmail.com";
	private static String PASSWORD = "disk4ever"; // GMail password
	...
	private void setTriggeredLineOfInquiry(Mail mail) {
		...
		for (Mail mail : emails) {
			try {
				...
				if (mail.getHypothesisId() != null) {
					...
					if (mail.getResults() == null
							|| !mail.getResults().equals(results)) {
